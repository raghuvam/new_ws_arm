...
#include <include/link_api/streamerLink.h>
#include <linux/src/links/streamer/streamerLink_priv.h>
#include "EncNull.h"
...
StreamerLink_CreateParams streamerLinkPrm;
...
int frameStreamHandler(System_BitstreamBuffer *bitstreamBuf,StreamerLink_Obj *pObj)
{
...
/////
 ...
 Void Chains_VipSingleCamEncNull_SetLinkId(Chains_VipSingleCamEncNullObj *pObj)
{
    ...
    pObj->ipcInLink_CPU_Id      = SYSTEM_MAKE_LINK_ID(SYSTEM_PROC_A15_0, SYSTEM_LINK_ID_IPC_IN_0);

    pObj->streamerLinkId   = A15_0_LINK(SYSTEM_LINK_ID_STREAMER_0);
 ...
 *******************************************************************************
*/
 Void Chains_VipSingleCamEncNull_ResetLinkPrms(
                                  Chains_VipSingleCamEncNullObj *pObj)
{
    ...
    StreamerLink_CreateParams_Init(&pObj->streamerLinkPrm);
 ...
 *******************************************************************************
*/
 Void Chains_VipSingleCamEncNull_SetCapturePrms(
 ...
 *******************************************************************************
*/
 Void Chains_VipSingleCamEncNull_SetIPCPrms(
 ...
 *******************************************************************************
*/
 Void Chains_VipSingleCamEncNull_SetStreamerLinkPrms(
                                 StreamerLink_CreateParams *prm, Bool enableMode)
{
    prm->numInQue = 1;
    prm->dumpDataType = STREAMER_LINK_COPY_TYPE_BITSTREAM_FILE;
 ...
 *******************************************************************************
*/
 Void Chains_VipSingleCamEncNull_SetEncPrms(
 ...
 *******************************************************************************
*/
 Void Chains_VipSingleCamEncNull_ConnectLinks(
                                  Chains_VipSingleCamEncNullObj *pObj)
{
    ...
    pObj->ipcInLink_CPU_Prms.outQueParams.nextLink = pObj->streamerLinkId;
    pObj->streamerLinkPrm.inQueParams[0].prevLinkId    = pObj->ipcInLink_CPU_Id;
    pObj->streamerLinkPrm.inQueParams[0].prevLinkQueId = 0;
}
 ...
 *******************************************************************************
*/
 Int32 Chains_VipSingleCamEncNull_Create(
                                   Chains_VipSingleCamEncNullObj *pObj,
                                   Chains_Ctrl *chainsCfg)
{
    ...
    Chains_VipSingleCamEncNull_SetStreamerLinkPrms
                    (&pObj->streamerLinkPrm, chainsCfg->pollingMode);
    ...
    status = System_linkCreate(pObj->streamerLinkId,
                                &pObj->streamerLinkPrm,
                                sizeof(pObj->streamerLinkPrm));
    OSA_assert(status == SYSTEM_LINK_STATUS_SOK);
 ...
 *******************************************************************************
*/
 Int32 Chains_VipSingleCamEncNull_Start(
                                   Chains_VipSingleCamEncNullObj *pObj,
                                   Chains_Ctrl *chainsCfg)
{
    ...
    status = System_linkStart(pObj->streamerLinkId);
    OSA_assert(status == SYSTEM_LINK_STATUS_SOK);
 ...
 *******************************************************************************
*/
 Int32 Chains_VipSingleCamEncNull_Stop(
                                   Chains_VipSingleCamEncNullObj *pObj,
                                   Chains_Ctrl *chainsCfg)
{
    ...
    status = System_linkStop(pObj->streamerLinkId);
    OSA_assert(status == SYSTEM_LINK_STATUS_SOK);
 ...
 *******************************************************************************
*/
 Int32 Chains_VipSingleCamEncNull_Delete(
                                   Chains_VipSingleCamEncNullObj *pObj,
                                   Chains_Ctrl *chainsCfg)
{
    Int32 status;
    ...
    status = System_linkDelete(pObj->streamerLinkId);
    OSA_assert(status == SYSTEM_LINK_STATUS_SOK);
 ...
 *******************************************************************************
*/
 void Chains_VipSingleCamEncNull_printBufferStatistics(
                                  Chains_VipSingleCamEncNullObj *pObj)
{
    ...
    System_linkPrintBufferStatistics(pObj->streamerLinkId);
}
 ...
 *******************************************************************************
*/
 void Chains_VipSingleCamEncNull_PrintStatistics(
                                  Chains_VipSingleCamEncNullObj *pObj)
{
    ...
    System_linkPrintStatistics(pObj->streamerLinkId);
